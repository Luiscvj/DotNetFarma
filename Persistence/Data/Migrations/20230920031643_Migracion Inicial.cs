        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_departamento_pais_DepartamentoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Compras_medicamento_MedicamentoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Empleados_ciudad_CiudadId",
                        column: x => x.CiudadId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 200, new DateTime(2001, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 200000.0, 1 },
                    { 2, 150, new DateTime(2022, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 180000.0, 2 },
                    { 3, 100, new DateTime(2023, 10, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, 150000.0, 3 }
                });
            ...
            migrationBuilder.InsertData(
                table: "venta",
                columns: new[] { "VentaId", "Cantidad", "EmpleadoId", "FechaVenta", "MedicamentoId", "PacienteId", "Precio" },
                values: new object[,]
                {
                    { 1, 2, 1, new DateTime(2023, 2, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 1, 2200.0 },
                    { 2, 3, 2, new DateTime(2023, 4, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 2, 2700.0 },
                    { 3, 1, 3, new DateTime(2023, 7, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, 3, 1500.0 }
                });
